...
$sql = "UPDATE orders SET order_status = 'reject_return' WHERE order_id = ?";
$stmt = $ocon->prepare($sql);
$stmt->bind_param("i", $order_id);
$stmt->execute();

$sql2 = "UPDATE return_requests SET status = 'rejected' WHERE order_id = ?";
...
$message = "Yêu cầu trả hàng cho đơn #$order_id đã bị từ chối.";
